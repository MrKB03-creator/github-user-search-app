...
import { iconSearch, githubIconDarkmode } from "../assets/Images";
    ...
    <div className="flex justify-center items-center h-[100vh] bg-Darkmode_backgroundMain">
      <div className="lg:w-[730px] md:w-[563px] max-sm:w-[327px] h-auto flex flex-col">
        ...
        <main>
          ...
          <section className="w-full bg-Darkmode_backgroundContainer rounded-[15px] p-[32px] shadow-lg flex flex-col lg:relative lg:h-[444px] fit-content">
            ...
            <div className="lg:absolute left-[25%] top-[22%]">
              ...
              <div className="w-full mt-[37px]">
                <table className="grid grid-cols-2 gap-4 max-sm:flex-col">
                  <tr>
                    <td
                    ...
                    <td
                      className={`grid grid-cols-[30px,1fr] cursor-pointer max-sm:mb-[17px] ${
                        userData?.blog ? "text-Darkmode_Text" : "text-[#8E94A3]"
                      }`}
                    >
                      <svg
                        height="20"
